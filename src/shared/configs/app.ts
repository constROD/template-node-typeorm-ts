...
/* ORM */
export const ORM_SYNCHRONIZE =
  process.env.APP_ZONE === "production" ? false : true;
...
export const ORM_DB_SCHEMA =
  process.env.APP_ZONE === "production"
    ? `${process.env.APP_NAME}_production`
    : `${process.env.APP_NAME}_development`;
